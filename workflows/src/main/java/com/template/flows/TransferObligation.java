...
import com.template.contracts.Obligation;
...
import static com.template.contracts.ObligationContract.OBLIGATION_CONTRACT_ID;
...
public class TransferObligation {
    ...
    public static class Responder extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            progressTracker.setCurrentStep(SIGN_TRANSACTION);
            SignedTransaction stx = subFlow(new ObligationBaseFlow.SignTxFlowNoChecking(otherFlow, SignTransactionFlow.Companion.tracker()));
